# set - zbiór - przechowuje unikalne wartosci
# nie zachowuje kolejnosci podczas dodawania elementów

lista = [44, 55, 66, 777, 33, 22, 11, 33, 11]
zbior = set(lista)  # set() - zmiana na set
...
# pop() - usuniecie pierwszego elementu z listy
print(zbior.pop())  # 33
print(zbior.pop())  # 66
print(zbior.pop())  # 777
print(zbior.pop())  # 11
...
print(max(zb3))  # wartosc maxymalna
print(len(zb3))  # dlugosc
print(sorted(zb3))  # sortowanie
# 45
# 1
# 9
# 9
